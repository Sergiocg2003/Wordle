package com.api.wordle.controlador;

import com.api.wordle.modelo.Equipo;
import com.api.wordle.repositorio.EquipoRepo;
import com.api.wordle.repositorio.JugadorRepo;
...
public class EquipoController {
    ...
    public ResponseEntity<?> createEquipo(@RequestBody Equipo newEquipo){
        List<Equipo> equipoExiste = equipoRepo.findByNombreEqualsIgnoreCase(newEquipo.getNombre());
